...
const preguntas = [
    {
        pregunta: "¿Cuál es el lenguaje de programación que se utiliza principalmente para hacer sitios web interactivos?",
        opciones: ["Java", "Python", "JavaScript", "C#"],
        respuestaCorrecta: "JavaScript",
    },
    {
        pregunta: "¿Qué lenguaje de programación es conocido por su uso en el desarrollo de sistemas operativos?",
    ...
    {
        pregunta: "¿Cuál es el nombre de la función en Python que se usa para añadir elementos a una lista?",
    ...
    {
        pregunta: "¿Qué operador se usa en SQL para seleccionar un subconjunto de registros?",
    ...
    {
        pregunta: "¿Cuál de estos NO es un nivel de acceso en la programación orientada a objetos?",
...
function cargarPregunta() {
    ...
    const respuestaContainer = document.querySelector(".respuestas");
    ...
    pregunta.opciones.forEach((opcion) => {
        ...
        button.onclick = () => verificarRespuesta(opcion, button, pregunta.respuestaCorrecta);
        respuestaContainer.appendChild(button);
    });
    actualizarContadores();
}
function verificarRespuesta(opcionSeleccionada, button, respuestaCorrecta) {
